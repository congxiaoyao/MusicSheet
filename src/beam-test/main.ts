...
const cases: Case[] = [
  ...
  // ── 24. 4/4 四种典型节奏型各一小节 ──
  {
    title: '24. 4/4 四种节奏型（小节1: 8-16×4-8-16-8-16-8-8 / 小节2: 16-8×3-16×3-16-8-8 / 小节3: 4-8-8-4-8-8 / 小节4: 附点4-16-16-4-4）',
    ...
    piece: { clef: 'treble', key: CKEY, time: T44, notes: [
      ...
      // 小节3: 4 8 8 4 8 8 = 4拍(2组 4-8-8)
      n(C4, q), n(D4, e), n(E4, e), n(F4, q), n(G4, e), n(A4, e),
